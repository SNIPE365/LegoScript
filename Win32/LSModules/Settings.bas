...
#macro ForEachSetting( _do )
  ...
  _do( bGfxEnable        , "GfxWindow" , boolean  , true                , MenuTriggerIfTrue(meView_ToggleGW)     )  
  _do( bGfxCollision     , "GfxWindow" , boolean  , false               , MenuTriggerIfTrue(meView_ShowCollision))

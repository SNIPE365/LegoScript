...
#define AddRichA(  _ID , _X , _Y , _W , _H , _T , _S...) ControlA( _ID , cBrd , "richedit"  , _T , cRichStyle  , _X , _Y , _W , _H , _S )
#define AddRichW(  _ID , _X , _Y , _W , _H , _T , _S...) ControlW( _ID , cBrd , "richedit"  , _T , cRichStyle  , _X , _Y , _W , _H , _S )
